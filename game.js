...
maxDepth = 4;
ai = new Ai(populationSize, maxDepth); // population size // maxDepth of each tree
...
ai.population.sort(function(a,b) {return (a.fitness < b.fitness) ? 1 : ((b.fitness < a.fitness) ? -1 : 0);} );
ai.snake = snake2;
